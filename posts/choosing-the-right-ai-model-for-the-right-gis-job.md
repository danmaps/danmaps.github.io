---
title: "Choosing the Right AI Model for the Right GIS Job"
...
The theme is simple: **model choice is governance**.
...
2) **GIS Is a Domain, Not Just Python**
   Schema understanding and data judgment.

3) **Agents, Scripts, and the Cost of Autonomy**
   When the model decides what to do next.

4) *(Optional)* **A Practical Model Selection Matrix for GIS**
   A short, shareable decision table.

## House rules for the experiments

- Same prompt (or as close as possible).
- Same environment.
- Concrete evaluation: did it run, did it produce the right result, did it fail safely.
