...
This interaction model is usually called a **slippy map**: you grab the map itself, drag it continuously, and zoom without replacing the whole page. Google Maps made that pattern feel normal on the web after its 2005 launch, and it helped make page-at-a-time maps from the MapQuest era feel dated. The history is not quite “Keyhole invented it, then Google killed MapQuest,” though. Google Maps grew out of the team at Where 2 Technologies; Google acquired Keyhole around the same time, and Keyhole’s globe and imagery work became Google Earth. MapQuest was an earlier commercial web-mapping leader that Google eventually outpaced, but it is still around. [The Guardian’s account of the Where 2 team](https://www.theguardian.com/technology/2025/feb/09/google-maps-turns-20-anniversary-feature) and [Wired’s history of MapQuest](https://www.wired.com/beyond-the-beyond/2019/10/dead-media-beat-mapquest/) are good, more nuanced versions of that story.

To draw a point, measure its offset from the view center, multiply by the scale, and add the screen center. Subtract the y offset because screen y runs downward:
